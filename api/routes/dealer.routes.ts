...
// ============================================================================
// Mount in apps/api/src/routes/index.ts, e.g.:
//   import dealerRoutes from "./dealer.routes.js";
//   router.use("/api/v1/dealers", dealerRoutes.dealers);
//   router.use("/api/v1/dealer-routing", dealerRoutes.routing);
//   router.use("/api/v1/finance-cases", dealerRoutes.finance);
//   router.use("/api/v1/service-tickets", dealerRoutes.service);
//   router.use("/api/v1/spare-parts", dealerRoutes.spares);
// ============================================================================
