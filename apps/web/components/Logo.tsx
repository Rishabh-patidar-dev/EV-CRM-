// EV Vikas mark — a single mark reads as both letters at once: the left arm
...
export default function Logo({ className, style }: { className?: string; style?: CSSProperties }) {
  return (
    <svg viewBox="0 0 32 32" className={className} style={style} role="img" aria-label="EV Vikas">
      <path
