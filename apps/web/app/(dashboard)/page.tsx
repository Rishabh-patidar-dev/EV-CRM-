  ...
  return (
    <div className="mx-auto max-w-[1500px] p-6">
      <header className="mb-6">
        <h1 className="text-2xl font-semibold tracking-tight">VoltOs</h1>
      ...
      <section className="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
        ...
        <ModuleCard href="/dealer-inventory" icon={<Warehouse className="h-5 w-5" />} title="Vehicle Inventory" description="VIN-level stock from OEM warehouse through allocation, demo fleet, and sale, plus a BI dashboard." />
