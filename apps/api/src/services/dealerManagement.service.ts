...
//   - the Luxus Green Mobility product catalog (segments + models) for dropdowns
...
// ---------------------------------------------------------------------------
// Luxus Green Mobility product catalog — drives segment dropdowns and finance/service
