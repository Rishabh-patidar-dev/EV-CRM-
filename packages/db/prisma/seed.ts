// Local-dev seed data for Luxus Green Mobility. Resets and repopulates every table so
...
async function main() {
  ...
  const claim1 = await prisma.warrantyClaim.create({
    data: {
      ...
      measuredSohPct: 64,
      chargerType: "Luxus Green OEM Charger",
      serviceRecordsComplete: true,
      claimAmount: 45000,
      approvedAmount: 45000,
      status: "IN_REPAIR",
      adjudicationNotes: "Within time term: 8 of 60 months elapsed. Within distance term: 8200 of 100000km. Measured SoH 64% is below the 70% floor — capacity claim valid. Charger \"Luxus Green OEM Charger\" is an approved accessory. Service records complete. No open duplicate claim for this component.",
